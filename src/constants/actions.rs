...
pub const GET_SPACES_NAMES: u8 = 7u8;

pub const PING: u8 = 8u8;
pub const GET: u8 = 9u8;
pub const INSERT: u8 = 10u8;
pub const SET: u8 = 11u8;
pub const DELETE: u8 = 12u8;

pub const GET_AND_RESET_CACHE_TIME: u8 = 13u8;
